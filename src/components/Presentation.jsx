...
const Presentation = () => {
  ...
  >
    <p className="fade-in text-lg leading-relaxed text-center text-gray-200">
      Dès les premiers battements de mon cœur, un lien sacré s'est tissé avec
      les royaumes invisibles.
    </p>
    <blockquote className="fade-in text-xl font-semibold text-rose-400 text-center">
      Un fil d’or vibrant, hérité au tréfonds de mes gènes par mon
      arrière-grand-mère, celle qui m'a transmis ses dons de médiumnité et son
      magnétisme singulier.
    </blockquote>
    <p className="text-gray-200 fade-in text-lg leading-relaxed text-center">
      Très tôt, j’ai perçu les énergies subtiles qui rayonnaient tout autour de
      moi, telles des auréoles invisibles, éveillant en moi une destinée
      particulière.
    </p>
    <p className="text-gray-200 fade-in text-lg leading-relaxed text-center">
      À l’âge de 7 ans, à l’aube de mon innocence, j’ai pris conscience de ce
      lien privilégié avec l’au-delà. Des ressentis profonds et des émotions
      intenses, trop vastes pour que mon jeune être puisse les comprendre
      pleinement.
    </p>
    <p className="text-gray-200 fade-in text-lg leading-relaxed text-center">
      Aujourd’hui, guidée par les murmures des Anges et des Guides, je vous
      propose un accompagnement holistique unique. Grâce à une approche alliant
      psychologie positive et techniques énergétiques avancées, je vous aide à
      retrouver l’équilibre et à libérer votre plein potentiel.
    </p>
    <blockquote className="fade-in text-xl font-semibold text-rose-400 pb-7 text-center">
      “Révélez la plénitude de votre être et initiez un processus de renaissance
      vibratoire.”
    </blockquote>
  </div>
  <div className="p-20 border-t-2 border-rose-400">
  <TiltedScroll />
  </div>
</div>
  );
