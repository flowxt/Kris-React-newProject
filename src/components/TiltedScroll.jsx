...
const TiltedScroll = () => {
    const items = [
      { id: "1", text: "Soins énergétiques" },
      { id: "2", text: "Coaching Acceptation" },
      { id: "3", text: "Guidances" },
      { id: "4", text: "Massage bol tibétain" },
      { id: "5", text: "Méditation" },
      { id: "6", text: "Harmonisation énergétique des lieux" },
      { id: "7", text: "Lacher-prise" },
      { id: "8", text: "Tambour chamanique" },
    ];
    ...
    return (
      <div className="flex items-center justify-center">
        <div className="relative overflow-hidden [mask-composite:intersect] [mask-image:linear-gradient(to_right,transparent,black_5rem),linear-gradient(to_left,transparent,black_5rem),linear-gradient(to_bottom,transparent,black_5rem),linear-gradient(to_top,transparent,black_5rem)]">
          <div className="grid h-[250px] w-[300px] gap-5 animate-skew-scroll grid-cols-1 sm:w-[200px] sm:gap-3 sm:h-[200px] sm:grid-cols-1 lg:w-[400px] lg:h-[300px] lg:gap-6 lg:grid-cols-1">
            {items.map((item) => (
              <div
                key={item.id}
